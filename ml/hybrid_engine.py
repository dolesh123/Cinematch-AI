...
try:
    from ml.models import Movie, User
    from ml.unified_recommender import UnifiedRecommender
    from ml.nlp_recommender import NLPQueryRecommender
except ImportError:
    from models import Movie, User
    from unified_recommender import UnifiedRecommender
    from nlp_recommender import NLPQueryRecommender
...
class HybridRecommenderEngine:
    ...
    def generate_recommendations(
        ...
        first_seed_id = list(recent_movie_weights.keys())[0] if recent_movie_weights else None
        seed_movie_title = movie_map[first_seed_id].title if first_seed_id and first_seed_id in movie_map else None
